...
#ifndef ASTRO_ADAMS_H
#define ASTRO_ADAMS_H
...
/**
 * Propagates astrodynamics equations of motion using
 * Adams-Bashforth predictor with Adams-Moulton corrector, primed via RK4.
 *
 * @author  Kurt Motekew
 * @date    2025/10/21
 */
class Adams : public OdeSolver<JulianDate, double, 6> {
public:
  /**
   ...
   */
  Adams(std::unique_ptr<Ode<JulianDate, double, 6>> deq,
        const Duration& dt,
        const JulianDate& jd,
