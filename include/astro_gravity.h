...
/**
 * Indicates evaluation method to use for gravity models offering
 * efficient means for predictor/corrector integration schemes.
 */
enum class EvalMethod {
  predictor,                 ///< Complete spherical harmonic evaluation
  corrector                  ///< Central term update only
};
