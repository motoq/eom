...
#ifndef ASTRO_VINTI_J2_H
#define ASTRO_VINTI_J2_H
 ...
 * Vinti (Vinti6) orbit propagator with J3 set to zero.  See the
 * Vinti6.c source code.
 *
 ...
 * AIAA, 1998
 */
class VintiJ2 : public Ephemeris {
public:
  /**
   * Initialize VintiJ2
   *
   ...
   */
  VintiJ2(const JulianDate& epoch,
